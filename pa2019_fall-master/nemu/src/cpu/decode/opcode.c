...
instr_func opcode_entry[256] = {
    ...
    /* 0x84 - 0x87*/ test_r2rm_b, mytest_r2rm_v, inv, inv,
    ...
    /* 0xe8 - 0xeb*/ mycall_near, jmp_near, jmp_far_imm, jmp_short,
...
instr_func group_1_bv_entry[8] =
    {add_i2rm_bv, or_i2rm_bv, adc_i2rm_bv, inv, and_i2rm_bv, mysub_i2rm_bv, inv, cmp_i2rm_bv};
...
instr_func group_3_b_entry[8] =
    {test_i2rm_b, inv, inv, inv, mul_rm2a_b, inv, inv, idiv_rm2a_b};
...
instr_func group_5_indirect_entry[8] =
    {inc_rm_v, dec_rm_v, mycall_near_indirect, inv, jmp_near_indirect, inv, push_rm_v, inv};
